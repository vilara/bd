...
<div id="conteudo">
   ...
   <form name="navegador" id="formulario" method="post" action="index.php?secoes=consultas/pesc_rel&flag=1" enctype="multipart/form-data">
   <fieldset>
 ...
 <option value='2013' "selected">2013</option> 
    ...
    if ($flag == 1)
    {
    include_once "pesc_rel_mostrar.php";
    }
    ?>