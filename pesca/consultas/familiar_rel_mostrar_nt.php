        ...
        <div id="tabela">
            <table cellspacing="0" align="center" width="50%" class="bordasimples">
                ...
                ?>
                      ...
                      if ($par == "+cap") {
                       $sprod = 0;
            $sql2 = mysql_query("SELECT esp, sum(peso_g) AS pe, localidade, data  FROM pesc_col_familiar WHERE id_merc > 0 AND esp != 0 $data $local GROUP BY esp ORDER BY localidade, data, pe ASC ");
                        ...
                        while($registro2 = mysql_fetch_row($sql2))
                            ...
                            //  echo "<br>";
                             ...
                             ?>
                             <tr>
                                <td colspan="2" align="left" >Totais</td>
