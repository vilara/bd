...
if (url != " no") window.location = url;
 ...
 else if ($ano != "Todos" AND $mes == "Todos"){$data = " AND data LIKE '$ano-%'";}
   else if ($ano != "Todos" AND $mes != "Todos"){$data = " AND data LIKE '$ano-$mes%'";}
...
<div id="conteudo">
   ...
   <form name="navegador" id="formulario" method="post" action="index.php?secoes=consultas/res_familiar&flag=1" enctype="multipart/form-data">
   <fieldset>
 ...
 <option value='2013' "selected">2013</option> 
    ...
    if ($flag == 1)
    {
    include_once "res_familiar_mostrar.php";
    }
    ?>