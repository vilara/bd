   ...
   <li class="submenu"><a href="#">Cadastro</a>
      <ul class="menu">
       <!--  -->
        ...
        <li><a href="?secoes=cadastros/arquivo_inserir">Arquivos</a></li>
...
<li class="submenu"><a href="#">Registros</a>
   ...
   <li class="submenu"><a href="#">Consultas</a>
      <ul class="menu">
        ...
        <li><a href="?secoes=consultas/registros_tot">Registros totais</a></li>
        <li><a href="?secoes=consultas/registros_cp_min">Registros Cp Min</a></li>
          <li><a href="?secoes=consultas/registros_novo">Registros Novo</a></li>
...
<!--        <li><a href="?secoes=consultas/pesca">Pesca</a></li>-->
        ...
        <li><a href="?secoes=consultas/lista_abud_nova">Abundância</a></li>
  ...
  <li><a href="?secoes=consultas/spacefy">Specify</a></li>
   <li><a href="?secoes=consultas/corr">Corredeiras</a></li>
    <li><a href="?secoes=consultas/arquivos">Arquivos</a></li> 
  ...
  ?>
    ...
    <?php
     ...
     ?>
      ...
      <li class="submenu"><a href="#">Consulta nova</a>
        <ul class="menu">
        <li><a href="?secoes=consultas/bagres_pesc">Teste</a></li>
         <li><a href="?secoes=consultas/bagres_malh">Teste2</a></li>
