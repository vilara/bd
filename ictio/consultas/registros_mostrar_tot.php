...
<div id="tabelas">
        <div id="tabela">
                ...
                if ($aparelho == "Malhadeira")
                {
                      ...
                      if ($cod_lim == "Todas"){$codd = "";}else{$codd = " AND tb_malhadeira_biotico.malh_lim = $cod_lim";}
                    ...
                    $sql = mysql_query("SELECT * FROM tb_malhadeira_biotico INNER JOIN  tb_limno
                        ...
                        WHERE  tb_malhadeira_biotico.id_tb_malhadeira > '0' $espe ");
    ...
    header("Content-Disposition: attachment; filename=$aparelho.xls");
    ...
    header("Pragma: no-cache");
                      ...
                      $sql = mysql_query("SELECT * FROM tb_redinha_biotico INNER JOIN  tb_limno
                        ...
                        INNER JOIN tb_local ON  tb_limno.lim_local = tb_local.id_tab_local
                        WHERE  tb_redinha_biotico.id_tb_redinha > '0' $espe
                        ");
    ...
    header("Pragma: no-cache");
                      ...
                      <tr class="titulo">
                        ...
                        WHERE  tb_espinhel_biotico.id_tb_espi > '0' AND tb_limno_outr.lim_outr_aparelho = 'Espinhel' $espe
                        ");
    ...
    header("Pragma: no-cache");
                       ...
                       $sql = mysql_query("SELECT * FROM tb_arrastofundo_biotico INNER JOIN  tb_limno_arr
                        ...
                        WHERE  tb_arrastofundo_biotico.id_tb_arrastofundo > '0' $espe
                        ");
    ...
    header("Pragma: no-cache");
                ...
                $nn = 1;
                     ...
                     // Listagem das espécies capturadas de Redinha
                        ...
                        INNER JOIN tb_local ON  tb_limno_outr.lim_local = tb_local.id_tab_local
                        WHERE  tb_outros_biotico.id_tb_outros > '0' AND tb_limno_outr.lim_outr_aparelho = 'Outros' $espe
                        ");              $num = mysql_num_rows($sql);
    ...
    header("Pragma: no-cache");
                ...
                $nn = 1;
                     ...
                     // Listagem das espécies capturadas de Redinha
                        ...
                        INNER JOIN tb_especies ON  tb_outros_biotico.outr_especie = tb_especies.id_tab_especie
                        INNER JOIN tb_local ON  tb_limno_outr.lim_local = tb_local.id_tab_local
                        WHERE  tb_outros_biotico.id_tb_outros > '0' AND tb_limno_outr.lim_outr_aparelho = 'Caniço' $espe
                        ");              $num = mysql_num_rows($sql);
    ...
    header("Pragma: no-cache");
                ...
                // Listagem das espécies capturadas de Redinha
                        ...
                        INNER JOIN tb_especies ON  tb_outros_biotico.outr_especie = tb_especies.id_tab_especie
                        INNER JOIN tb_local ON  tb_limno_outr.lim_local = tb_local.id_tab_local
                        WHERE  tb_outros_biotico.id_tb_outros > '0' AND tb_limno_outr.lim_outr_aparelho = 'Puça' $espe
                        ");              $num = mysql_num_rows($sql);
    ...
    header("Pragma: no-cache");
                ...
                // Listagem das espécies capturadas de Redinha
                        ...
                        INNER JOIN tb_especies ON  tb_outros_biotico.outr_especie = tb_especies.id_tab_especie
                        INNER JOIN tb_local ON  tb_limno_outr.lim_local = tb_local.id_tab_local
                        WHERE  tb_outros_biotico.id_tb_outros > '0' AND tb_limno_outr.lim_outr_aparelho = 'Manual' $espe                   ");              $num = mysql_num_rows($sql);
    ...
    header("Pragma: no-cache");
                ...
                // Listagem das espécies capturadas de Redinha
                        ...
                        INNER JOIN tb_especies ON  tb_outros_biotico.outr_especie = tb_especies.id_tab_especie
                        INNER JOIN tb_local ON  tb_limno_outr.lim_local = tb_local.id_tab_local
                        WHERE  tb_outros_biotico.id_tb_outros > '0' AND tb_limno_outr.lim_outr_aparelho = 'Tarrafa' $espe                      ");                         $num = mysql_num_rows($sql);
                while($registro = mysql_fetch_row($sql))
                {
                $id_lim =  $registro[0];
                $hora =  $registro[4];
