...
<h3>Parâmetros da consulta do número de espécies capturadas</h3>
 <form id="formulario" method="post" action="index.php?secoes=consultas/mapa3&flag=1" enctype="multipart/form-data">
    <fieldset>
...
<td>&nbsp;</td>
 ...
 &nbsp;
     ...
     <tr>
    <td>
4) Genética: </td><td><label for="gen">



            <input type="radio" name="gen" value="s"  class="checkbox"/>Sim&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <input type="radio" name="gen"  value="n"  checked="checked" class="checkbox"/>Não&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
if ($flag == 1)
{
		include_once "mapa3_mostrar.php";
}
          ?>