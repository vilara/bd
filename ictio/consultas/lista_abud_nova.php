...
<h3>Parâmetros da consulta do número de espécies capturadas</h3>
 <form id="formulario" method="post" action="index.php?secoes=consultas/lista_abud_nova&flag=1" enctype="multipart/form-data">
    <fieldset>
...
?>
           ...
           <!-- <option value='Todos'>Todos</option>-->
                   <option value='Todos'>Todos (Malh,Red,Espi,Tarr,Puça)</option> 
...
if ($flag == 1)
{
		include_once "lista_abud_mostrar_nova.php";
}
          ?>