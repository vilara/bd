...
$sql = mysql_query("SELECT espi_esp, count(espi_esp) FROM tb_espinhel_biotico WHERE id_tb_espi > '0' GROUP BY espi_esp");
...
$sql1 = mysql_query("SELECT espi_esp FROM tb_espinhel_biotico WHERE espi_esp = '$esp' AND (espi_lim = '$outr_lim' $lim)");
