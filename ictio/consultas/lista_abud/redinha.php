...
$sql = mysql_query("SELECT red_especie, count(red_especie) FROM tb_redinha_biotico WHERE id_tb_redinha > '0' GROUP BY red_especie");
...
$red_lim = " ";
$lim = " ";
$sqla = mysql_query("SELECT id_tb_limno FROM tb_limno WHERE id_tb_limno >= 1 AND lim_aparelho = 'redinha' $excu1 ");
