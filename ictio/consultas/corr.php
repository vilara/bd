...
?>
<div id="conteudo">
   <h3>Parâmetros da consulta de espécies capturadas em Corredeiras</h3>
...
-->           <!--  <option value='index.php?secoes=consultas/corr&aparelho=Arrasto de fundo&exc=<?php echo"$exc";?>&flag=1&flag1=1' <?php echo"$ar";?>>Arrasto Bentônico</option> -->
             <option value='index.php?secoes=consultas/corr&aparelho=Puça&exc=<?php echo"$exc";?>&flag=1&flag1=1' <?php echo"$pu";?>>Puça</option>
