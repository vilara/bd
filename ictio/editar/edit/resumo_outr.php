...
$sql = mysql_query("SELECT outr_numero,outr_especie,sum(outr_qtde) AS quant,outr_teci,outr_voucher,outr_foto,outr_det,outr_obs FROM tb_outros_biotico WHERE id_tb_outros > '0' AND outr_lim = $lim GROUP BY outr_especie ORDER BY quant DESC");
