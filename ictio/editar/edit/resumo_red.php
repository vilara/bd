...
$sql = mysql_query("SELECT red_numero,red_especie,sum(red_qtde) AS quant,red_teci,red_voucher,red_foto,red_det,red_obs FROM tb_redinha_biotico WHERE id_tb_redinha > '0' AND red_lim = $lim GROUP BY red_especie ORDER BY quant DESC");
