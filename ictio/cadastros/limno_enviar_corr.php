...
$cadastra->setTable("tb_limno_corr");
$cadastra->setFields("`id_tb_limno` , `lim_corr_excursao` , `lim_corr_cod` , `lim_corr_aparelho` , `lim_corr_local` , `lim_corr_data` , `lim_corr_dren` ,  `lim_corr_lat_g` , `lim_corr_long_g` , `lim_corr_colet` , `lim_corr_pesc`  , `lim_corr_fluxo1`, `lim_corr_fluxo2`  , `lim_corr_prof` , `lim_corr_transp` , `lim_corr_turb1` , `lim_corr_turb2`  , `lim_corr_turb3`  , `lim_corr_condut` , `lim_corr_ph` , `lim_corr_o2diss` ,   `lim_corr_o2sat` , `lim_corr_temp` , `lim_corr_larg_rio` , `lim_corr_substr` , `lim_corr_localidade` , `lim_corr_habitat` , `lim_corr_padronizado` , `lim_corr_hora_ini` , `lim_corr_condut2` , `lim_corr_lat_m` , `lim_corr_lat_s` , `lim_corr_long_m` , `lim_corr_long_s` , `lim_corr_an` , `lim_corr_obs`");
$cadastra->setDados("NULL , '$lim_excursao', '$lim_cod', '$lim_aparelho', '$lim_local', '$lim_data', '$lim_dren', '$lim_lat_g', '$lim_long_g', '$lim_colet', '$lim_pesc', '$lim_fluxo1', '$lim_fluxo2', '$lim_prof', '$lim_transp', '$lim_turb1',  '$lim_turb2', '$lim_turb3', '$lim_condut', '$lim_ph', '$lim_o2diss', '$lim_o2sat', '$lim_temp', '$lim_larg_rio', '$lim_substr', '$lim_localidade', '$lim_habitat', '$lim_padronizado', '$lim_hora_ini', '$lim_condut2' , '$lim_lat_m' , '$lim_lat_s' , '$lim_long_m' , '$lim_long_s' , '$lim_an' , '$lim_obs'");
$cadastra->insert();
