...
<div id="tabelas">
        ...
        <tr class="titulo">
           ...
           ?>
             ...
             <?php
             $sql1 = mysql_query("SELECT * FROM `tb_malhadeira_biotico` WHERE `malh_teci` LIKE '%$pesq%' AND `malh_teci` != 'Não' ");
             $num1 = mysql_num_rows($sql1);
             $sql2 = mysql_query("SELECT * FROM `tb_redinha_biotico` WHERE `red_teci` LIKE '%$pesq%'  AND `red_teci` != 'Não' ");
             $num2 = mysql_num_rows($sql2);
             $sql3 = mysql_query("SELECT * FROM `tb_arrastofundo_biotico` WHERE `arr_teci` LIKE '%$pesq%'  AND `arr_teci` != 'Não' ");
             $num3 = mysql_num_rows($sql3);
             $sql4 = mysql_query("SELECT * FROM `tb_outros_biotico` WHERE `outr_teci` LIKE '%$pesq%' AND `outr_teci` != 'Não'  ");
             $num4 = mysql_num_rows($sql4);
             /*$sql5 = mysql_query("SELECT * FROM `tb_pesc_biotico` WHERE `pesc_voucher` = $pesq ");
             $num5 = mysql_num_rows($sql5);*/
              $sql6 = mysql_query("SELECT * FROM `tb_espinhel_biotico` WHERE `espi_teci` LIKE '%$pesq%' AND `espi_teci` != 'Não'  ");
             ...
             <tr>
                ...
                <td title="Registros"><?php echo "$registro1[17]"; ?></td>
                 ...
                 <td title="Registros"><?php echo "$registro1[22]"; ?></td>    <td title="Registros"><?php echo "$registro1[21]"; ?></td>
         ...
         <!--        <tr>
            ...
            //  }
             ...
             <tr>
                ...
                <td title="Registros"><?php echo "$registro6[21]"; ?></td>   <td title="Registros"><?php echo "$registro6[22]"; ?></td>
                <td title="Registros">
