...
$dado->setTable("tb_local");
$dado->setFieldId("loc_descricao = '$pesq'");
$dado->setFieldNr("0"); $locc = $dado->data_filter();


             $sql1 = mysql_query("SELECT * FROM `tb_limno` WHERE `lim_local` =  '$locc' ORDER BY lim_excursao, lim_data ASC ");
             $num = mysql_num_rows($sql1);
             $sql2 = mysql_query("SELECT * FROM `tb_limno_arr` WHERE `lim_arr_loc` =  '$locc' ORDER BY lim_arr_excursao, lim_arr_data ASC ");
             $num2 = mysql_num_rows($sql2);
             $sql3 = mysql_query("SELECT * FROM `tb_limno_outr` WHERE `lim_local` =  '$locc' ORDER BY lim_outr_excursao, lim_outr_aparelho, lim_outr_data ASC ");
