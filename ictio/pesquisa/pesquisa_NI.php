...
// echo "Brasil";
$sql = mysql_query("SELECT * FROM `tb_especies` WHERE `id_tab_especie` =  '724'");
        ...
        <br />
         ...
         //   echo " <br> $id <br>";
           ...
           <table cellspacing="0" align="center" width="900px" class="bordasimples">
             ...
             ?>
             <tr class="titulo">
                <td colspan="16" align="left">&nbsp;&nbsp;&nbsp;<?php echo"Não Identificadas"; ?></td>
             </tr>
            ...
            //   echo "$lim";
             ...
             <tr>
                ...
                <td title="Registros"><?php echo "-"; ?></td>
                <td title="Registros"><?php echo "-"; ?></td>
                  <td title="Registros"><?php echo "$registro5[23]"; ?></td>
            ...
            <!--    <a href="javascript:janelaSecundaria('editar/index.php?secoes=edit/editar_malh_inserir&idd=<?php echo"$registro4[0]";?>&aparelho=Outros; ?>')" >   -->
             ...
             <tr>
                ...
                <td title="Registros"><?php echo "-"; ?></td>
                <td title="Registros"><?php echo "-"; ?></td>
                  <td title="Registros"><?php echo "$registro6[22]"; ?></td>  
