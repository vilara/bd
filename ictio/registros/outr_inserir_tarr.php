...
?>
 <?php include "log_auth1.php"; ?>
       ...
       <!-- <h1>Banco de dados do Laboratório de Ictiologia da UNIR</h1>   -->
        <h3>Inserir dados de coleta de tarrafa</h3>
...
<form name="navegador" method="post" action="index.php?secoes=registros/outr_inserir1_tarr&flag=1" enctype="multipart/form-data">
 ...
 <fieldset>
    ...
    <label for="exc"> 1) Excursão:  </label>
            ...
            <option value="no">Selecione</option>
              ...
              {
                ?>
            <option value="index.php?secoes=registros/outr_inserir_tarr&exc=0&flag=0">Geral</option>
           ...
           ?>    <option value="index.php?secoes=registros/outr_inserir_tarr&exc=0&flag=0">Geral</option>
               ...
               $lista->geraListaExc2(outr_inserir_tarr);
           ?>
               </select>
        <label for="limno">
            2) Código de campo:
             ...
             <SELECT name='outr_lim' type='text' id='outr_lim' tabindex="1" ><OPTION>
              <?php
                ...
                $lista->geraListaCodCampoOutrTarr($exc);
              ?>
