...
<h3>Registro Nr:&nbsp;<span class="red"><?php echo"$outr_numero4 de $cod";  ?></span> </h3>
   ...
   <?php
    ...
    <div align="center">Último registro para Coleção: <span class="red">(Esp: <?php echo"$esp";  ?>&nbsp;&nbsp;<?php echo"$outr_voucher";  ?>)</span></div>
       ...
       ?>
    <form id="forms" method="post" action="index.php?secoes=registros/outr_enviar&outr_lim=<?php echo "$outr_lim"; ?>&outr_hora=<?php echo "$outr_hora"; ?>&outr_data=<?php echo "$outr_data"; ?>" enctype="multipart/form-data">
      <fieldset>
