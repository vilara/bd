...
#edicao select { border:1px solid #616161; }
   ...
   <div id="edicao">
      ...
      <h3>Inserir dados de coleta de corredeira</h3>
...
$dado->setTable("tb_corr_biotico");
$dado->setFieldOrder("id_tb_corr");
...
<br />
    <!--Tecido:&nbsp;&nbsp;GEN<?php echo"$nr_gen3";  ?> <br /> -->
     ...
     if ($red_col66 == "Sim")
       {
      ?>
    <div align="center">Último registro para Coleção:<span class="red"> (Esp: <?php echo"$esp";  ?>&nbsp;&nbsp;<?php echo"$red_voucher";  ?>)</span></div>
       <?php
       }
       ?>
    <form id="forms" method="post" action="index.php?secoes=registros/corr_enviar&red_lim=<?php echo "$red_lim"; ?>&red_hora=<?php echo "$red_hora"; ?>&lim_data=<?php echo "$lim_data"; ?>" enctype="multipart/form-data">
      <fieldset>
        ...
        <label for="comprimento">
           ...
           <label for="aparelho">
        15) Tecido:  </label>  <input name="red_teci" type="text" id="red_teci" tabindex="11" accesskey="c" size="8" />
            <!--<input type="radio" name="red_teci"  value="Sim" class="checkbox" >Sim&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <input type="radio" name="red_teci" value="Não" class="checkbox"  checked>Não-->
        ...
        16) Foto:  </label>
            ...
            <input type="radio" name="red_foto" value="Não" class="checkbox"  checked>Não

        <label for="aparelho">
        17) Coleção:  </label>
            <input type="radio" name="red_col"  value="Sim"  class="checkbox" >Sim&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <input type="radio" name="red_col" value="Não"  class="checkbox" checked>Não
        ...
        <input type="radio" name="red_anali"  value="Sim"  class="checkbox" >Sim&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <input type="radio" name="red_anali" value="Não"  class="checkbox" checked>Não-->
