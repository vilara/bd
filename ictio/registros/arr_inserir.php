...
url = document.navegador.lim_arr_exc.options[document.navegador.lim_arr_exc.selectedIndex].value
...
?>
 ...
 <div id="edicao">
     <!--   <h1>Banco de dados do Laboratório de Ictiologia da UNIR</h1> -->
        <h3>Inserir dados de coleta de Arrasto Bentônico</h3>
        
<!--Área editável início     -->
 

 <?php include "log_auth1.php"; ?>
<form name="navegador" method="post" action="index.php?secoes=registros/arr_inserir1&flag=1" enctype="multipart/form-data">
 ...
 <fieldset>
    ...
    <label for="exc"> 1) Excursão:  </label>
              <SELECT name='lim_arr_exc' onchange="destino()" type='text' id='lim_arr_exc' tabindex="4">
                <?php
              if ($flag == 9)
              {
                ?>
            <option value="no">Selecione</option>
              ...
              {
                ?>
            <option value="index.php?secoes=registros/arr_inserir&exc=0&flag=0">Geral</option>
           ...
           ?>   <option value="index.php?secoes=registros/arr_inserir&exc=0&flag=0">Geral</option>
               ...
               $lista->geraListaExc2(arr_inserir);
           ?>
               </select>
            ...
            1) Código de campo:
             ...
             <SELECT name='arr_lim' type='text' id='arr_lim' tabindex="1" ><OPTION>
               <?php
                ...
                $lista->geraListaCodCampoArr($exc);
