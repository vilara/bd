...
<form name="navegador" method="post" action="index.php?secoes=registros/red_inserir1&flag=1" enctype="multipart/form-data">
 ...
 <fieldset>
    ...
    <label for="exc"> 1) Excursão:  </label>
            ...
            <option value="no">Selecione</option>
              ...
              {
                ?>
            <option value="index.php?secoes=registros/red_inserir&exc=0&flag=0">Geral</option>
           ...
           ?>   <option value="index.php?secoes=registros/red_inserir&exc=0&flag=0">Geral</option>
               ...
               $lista->geraListaExc2(red_inserir);
           ?>
        ...
        <label for="limno">
            1) Código de campo:
             ...
             <?php
                ...
                $lista->geraListaCodCampo1("Redinha",$exc);
