...
<script>parent.location.href='index.php?secoes=registros/can_inserir1&outr_lim=<?php echo "$outr_lim"; ?>&outr_hora=<?php echo "$outr_hora"; ?>&outr_especie=<?php echo "$outr_especie"; ?>&col=<?php echo "$rr"; ?>&outr_voucher=<?php echo "$outr_voucher"; ?>&flag=2'</script>;
<!-- 
-->
