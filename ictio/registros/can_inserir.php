...
<form name="navegador" method="post" action="index.php?secoes=registros/can_inserir1&flag=1" enctype="multipart/form-data">
 ...
 <fieldset>
    ...
    <label for="exc"> 1) Excursão:  </label>
            ...
            <option value="no">Selecione</option>
              ...
              {
                ?>
            <option value="index.php?secoes=registros/can_inserir&exc=0&flag=0">Geral</option>
           ...
           ?>            <option value="index.php?secoes=registros/can_inserir&exc=0&flag=0">Geral</option>       
               ...
               $lista->geraListaExc2(can_inserir);
           ?>
               </select>
        <label for="limno">
            2) Código de campo:
             ...
             <SELECT name='outr_lim' type='text' id='outr_lim' tabindex="1" ><OPTION>
              <?php
                ...
                $lista->geraListaCodCampoCan($exc);
              ?>
