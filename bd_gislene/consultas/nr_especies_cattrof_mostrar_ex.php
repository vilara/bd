...
<td colspan="14">Aparelho: <?php echo"$aparelho ";?>
...
$bb1 = 0;$bb2 = 0;$bb3 = 0;$bb4 = 0;$bb5 = 0;$bb6 = 0;$bb7 = 0;$bb8 = 0;$bb9 = 0;$bb10 = 0;$bb11 = 0;$bb12 = 0;
...
$sql = mysql_query("SELECT bio_esp_id FROM tb_biotico1 WHERE bio_local = '$loc' $apare $excu $bio ORDER BY bio_esp_id");
...
$tot2 = $b1 + $b2 + $b3 + $b4 + $b5 + $b6 + $b7 + $b8 + $b9 + $b10 + $b11 + $b12;
