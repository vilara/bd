...
<h3>Parâmetros da consulta do número de espécies por Categoria trófica</h3>
 <form id="formulario" method="post" action="index.php?secoes=consultas/nr_especies_cattrof&flag=1" enctype="multipart/form-data">
    <fieldset>
...
if ($flag == 1)
{
		include_once "nr_especies_cattrof_mostrar.php";
}
          ?>